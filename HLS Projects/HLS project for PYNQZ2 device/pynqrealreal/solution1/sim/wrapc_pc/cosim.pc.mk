...
$(ObjDir)/simple_mnist.c_pre.c.tb.o : simple_mnist.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) simple_mnist.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/ebnn_mnist.c_pre.c.tb.o : ebnn_mnist.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) ebnn_mnist.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
