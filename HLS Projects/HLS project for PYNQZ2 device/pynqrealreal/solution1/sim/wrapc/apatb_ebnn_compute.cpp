...
#define AUTOTB_TVIN_input_r  "../tv/cdatafile/c.ebnn_compute.autotvin_input_r.dat"
// wrapc file define: "output_r"
#define AUTOTB_TVOUT_output_r  "../tv/cdatafile/c.ebnn_compute.autotvout_output_r.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "output_r"
#define AUTOTB_TVOUT_PC_output_r  "../tv/rtldatafile/rtl.ebnn_compute.autotvout_output_r.dat"
...
extern "C" void ebnn_compute (
float input[15680],
char output[20]);

extern "C" void AESL_WRAP_ebnn_compute (
float input[15680],
char output[20])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<8> *output_r_pc_buffer = new sc_bv<8>[20];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: output_r
				{
					...
					// {
						// celement: output(7, 0)
						// {
							sc_lv<8>* output_lv0_0_19_1 = new sc_lv<8>[20];
						// }
					// }
					...
					// bitslice(7, 0)
					{
						...
						// celement: output(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 19; i_0 += 1)
							{
								...
								{
									output_lv0_0_19_1[hls_map_index].range(7, 0) = sc_bv<8>(output_r_pc_buffer[hls_map_index].range(7, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(7, 0)
					{
						...
						// celement: output(7, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 19; i_0 += 1)
							{
								...
								// output_type_conversion : (output_lv0_0_19_1[hls_map_index]).to_uint64()
								if (&(output[0]) != NULL) // check the null address if the c port is array or others
								{
									output[i_0] = (output_lv0_0_19_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		sc_bv<32>* input_r_tvin_wrapc_buffer = new sc_bv<32>[15680];
		...
		tcl_file.set_num(15680, &tcl_file.input_r_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<8>* output_r_tvout_wrapc_buffer = new sc_bv<8>[20];
		...
		tcl_file.set_num(20, &tcl_file.output_r_depth);
