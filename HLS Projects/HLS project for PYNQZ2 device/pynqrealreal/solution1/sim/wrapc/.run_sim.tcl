...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ebnn_compute.autotvin.dat"
	set constFileTvOut       "ebnn_compute.autotvout.dat"
	set constFileHdlTvIn     "ebnn_compute.autohdltvin.dat"
	set constFileHdlTvOut    "ebnn_compute.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
