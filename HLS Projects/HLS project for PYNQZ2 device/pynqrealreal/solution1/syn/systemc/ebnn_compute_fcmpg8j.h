...
#ifndef __ebnn_compute_fcmpg8j__HH__
#define __ebnn_compute_fcmpg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ebnn_compute_fcmpg8j) {
    ...
    SC_CTOR(ebnn_compute_fcmpg8j):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
