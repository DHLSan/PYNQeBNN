...
#ifndef __ebnn_compute_fadddEe__HH__
#define __ebnn_compute_fadddEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(ebnn_compute_fadddEe) {
    ...
    SC_CTOR(ebnn_compute_fadddEe):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
