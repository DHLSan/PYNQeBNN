...
#ifndef __ebnn_compute_sitosc4__HH__
#define __ebnn_compute_sitosc4__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(ebnn_compute_sitosc4) {
    ...
    SC_CTOR(ebnn_compute_sitosc4):  ACMP_sitofp_U ("ACMP_sitofp_U") {
