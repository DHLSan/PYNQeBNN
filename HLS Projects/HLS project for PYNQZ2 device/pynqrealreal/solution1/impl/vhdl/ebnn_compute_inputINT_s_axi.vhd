...
entity ebnn_compute_inputINT_s_axi is
generic (
...
end entity ebnn_compute_inputINT_s_axi;
...
architecture behave of ebnn_compute_inputINT_s_axi is
    type states is (wridle, wrdata, wrresp, wrreset, rdidle, rddata, rdreset);  -- read and write fsm states
    signal wstate  : states := wrreset;
    signal rstate  : states := rdreset;
    signal wnext, rnext: states;
    constant ADDR_INPUT_R_BASE : INTEGER := 16#10000#;
    constant ADDR_INPUT_R_HIGH : INTEGER := 16#1ffff#;
    ...
    -- memory signals
    signal int_input_r_address0 : UNSIGNED(13 downto 0);
    ...
    signal int_input_r_address1 : UNSIGNED(13 downto 0);
    ...
    component ebnn_compute_inputINT_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component ebnn_compute_inputINT_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_input_r
int_input_r : ebnn_compute_inputINT_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 15680,
     AWIDTH   => log2(15680))
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_input_r_read = '0') else '0';
    RVALID    <= RVALID_t;
...
-- ----------------------- Memory logic ------------------
    ...
    int_input_r_address1 <= raddr(15 downto 2) when ar_hs = '1' else waddr(15 downto 2);
...
entity ebnn_compute_inputINT_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity ebnn_compute_inputINT_s_axi_ram;

architecture behave of ebnn_compute_inputINT_s_axi_ram is
