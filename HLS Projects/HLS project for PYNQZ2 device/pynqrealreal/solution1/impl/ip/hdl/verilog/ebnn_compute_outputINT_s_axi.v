...
`timescale 1ns/1ps
module ebnn_compute_outputINT_s_axi
#(parameter
...
//------------------------Parameter----------------------
localparam
    ADDR_OUTPUT_R_BASE = 6'h20,
    ADDR_OUTPUT_R_HIGH = 6'h3f,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
    WRRESET            = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [1:0]                    int_output_r_shift;

//------------------------Instantiation------------------
// int_output_r
ebnn_compute_outputINT_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 5 )
) int_output_r (
    .clk0     ( ACLK ),
...
assign int_output_r_be0      = 1 << output_r_address0[1:0];
...
always @(posedge ACLK) begin
    if (ACLK_EN) begin
        if (output_r_ce0)
            int_output_r_shift <= output_r_address0[1:0];
    end
end
...
module ebnn_compute_outputINT_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
