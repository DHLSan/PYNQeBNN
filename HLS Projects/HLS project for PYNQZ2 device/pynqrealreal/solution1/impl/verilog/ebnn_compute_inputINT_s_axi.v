...
`timescale 1ns/1ps
module ebnn_compute_inputINT_s_axi
#(parameter
    ...
    input  wire                          RREADY,
    // user signals
    input  wire [13:0]                   input_r_address0,
...
//------------------------Parameter----------------------
localparam
    ADDR_INPUT_R_BASE = 17'h10000,
    ADDR_INPUT_R_HIGH = 17'h1ffff,
    WRIDLE            = 2'd0,
    WRDATA            = 2'd1,
    WRRESP            = 2'd2,
    WRRESET           = 2'd3,
...
//------------------------Instantiation------------------
// int_input_r
ebnn_compute_inputINT_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 15680 )
) int_input_r (
    .clk0     ( ACLK ),
...
assign int_input_r_address1 = ar_hs? raddr[15:2] : waddr[15:2];
...
module ebnn_compute_inputINT_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
